...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-center'>
        ...
        <div className='flex flex-row items-center justify-center thin-border opacity-75  rounded-full px-1 m-7 gap-7  font-thin max-w-[64rem]'>
            {navItems.map((item, index) =><div className='' key={index}>{item}</div>)}
        </div>
